...
<div class="navbar navbar-expand-lg bg-light navbar-light">
	...
	<div class="card bg-light">
		<article class="card-body mx-auto" style="max-width: 400px;">
			<h3 class="card-title mt-3 text-center" id="h3">회원 가입</h3><br/>
			<form id="frm" name="frm" class="form-text" action="memberInsert.do" method="post" onsubmit="return formCheck()">
				...
				<div class="form-group input-group">
					...
					<input type="button" class="btnAdr" onclick="execPostcode()" value="우편번호 찾기">
				</div>
				<div class="form-group input-group">
					<div class="input-group-prepend">
						<span class="input-group-text"> <i class="far fa-address-card"></i></span>
				...
				<div class="form-group input-group">
					...
					<input type="text" id="sample6_detailAddress" name="detailAdr" placeholder="상세주소" class="form-control">
				</div>
				<!-- 생년월일 입력 -->
				<div class="form-group input-group">
					<div class="input-group-prepend">
